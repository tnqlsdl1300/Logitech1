...
<script type="text/javascript">
      ...
      $("input.checkclass").each(function(index, item) {
         ...
         $("#colorselec"+index).change(function() {
            ...
            if(cnt2 == 1){
               ...
               $.ajax({
                      url:"<%= ctxPath%>/mypage/selectcolor.up",
   ...
   function goCancel() {
      ...
      location.href="/Logitech/mypage/ordercart.up?seqcart="+seqcart;
...
<div class="container">
         ...
         <c:forEach var="pvo" items="${cartprolist}" varStatus="status">
            <tr id="titlehead2">
               ...
               <td class="info"><span><span id="proid${status.index}">${pvo.pcvo.fk_productid}</span><br />
                  ...
                  <form id="colorform${status.index}" method="post" action="ordercart.up">
                     ...
                     <input type="text" id="seqcart${status.index}" value="${pvo.pcvo.sq_cart}"/>
   ...
   <div id="seconddiv">
      <li>상품구매금액 25,000 + 배송비 2,500 = 합계 : 27,500원</li>
   </div>
   <hr>
