...
public class GoogleMail {
	...
	public void sendmail(String recipient, String certificationCode) throws Exception {
    	...
    	prop.put("mail.smtp.user", "conbrio04@gmail.com");
    	...
    	// 보내는 사람의 메일주소
    	String sender = "conbrio04@gmail.com";
	...
	public void sendmail(String name, String recipient, String content) throws Exception {
    	...
    	// 제목 설정
    	String subject = name + " 회원님의 일대일 문의에 대한 답변 메일입니다.";
    	msg.setSubject(subject);
